...
```
![Task 1.1](./images/01-task-1.1-dry-run-client.png)
...
```
![Task 1.2](./images/02-task-1.2-pod-inspection.png)

```bash
# Read the logs
kubectl logs nginx-pod
```
![Task 1.3](./images/03-task-1.3-pod-logs.png)
...
![Task 2.1](./images/05-task-2.1-busybox-pod.png)
...
![Task 3.1](./images/06-task-3.1-create-redis-pod.png)
...
![Task 3.2](./images/07-task-3.2-export-redis-yaml.png)
...
![Task 3.3](./images/08-task-3.3-generate-pod-yaml.png)
...
![Task 4.1](./images/09-task-4.1-server-validation.png)
...
![Task 5.1](./images/10-task-5.1-view-pod-labels.png)
...
![Task 5.2](./images/11-task-5.2-select-labels.png)
...
![Task 5.3](./images/12-task-5.3-update-labels.png)
...
![Task 5.4](./images/13-task-5.4-verify-labels.png)
...
![Task 5.5](./images/14-task-5.5-create-tools-pod.png)
